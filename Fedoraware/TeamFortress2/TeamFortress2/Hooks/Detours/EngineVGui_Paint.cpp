	...
	if (iMode & PAINT_UIPANELS)
	{
		...
		StartDrawing(I::VGuiSurface);
		{
			if (g_Draw.m_vecFonts.empty())
			{
				g_Draw.RemakeFonts
				({
					{ 0x0, "calibri", 14, 800, FONTFLAG_OUTLINE}, //esp
					{ 0x0, "calibri", 14, 800, FONTFLAG_OUTLINE}, //name esp (jeff font)
					{ 0x0, "calibri", 12, 800, FONTFLAG_OUTLINE}, //cond esp
					{ 0x0, "calibri", 12, 800, FONTFLAG_OUTLINE}, //pickup esp
